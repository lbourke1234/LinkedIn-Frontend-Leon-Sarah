  ...
  return (
    <div className="the-whole-card-news-feed-top">
      <div className="top-section-profile-pic-and-search-bar">
        ...
        <Form inline className="form-top-news-top">
          <FormControl
            ...
            className="mr-sm-2 search-field-top-bar-news-feed"
            onClick={() => {
              setModalShow(true)
            }}
          />
      ...
      <div className="icons-section-top-news-section">
        <i class="bi bi-image actual-icons-news-feed-top">
          <p className="text-next-to-icons">Photo</p>
        </i>

        <i class="bi bi-play-btn actual-icons-news-feed-top">
          <p className="text-next-to-icons">Video</p>
        </i>
        <i class="bi bi-calendar4-event actual-icons-news-feed-top">
          <p className="text-next-to-icons">Event</p>
        </i>
        <i class="bi bi-pencil-square actual-icons-news-feed-top">
          <p className="text-next-to-icons">Write article</p>
        </i>
      </div>
    </div>
  )
